...
#     allowed_globals = {"__builtins__": __builtins__,"scipy": __import__("scipy"), "numpy": __import__("numpy"), "math": __import__("math")}
#     #local_vars = {}
...
#         exec(input.code, allowed_globals)
#         #exec(input.code)
...
#     allowed_commands = ["ls", "cat", "pwd", "df",0 "whoami"]
